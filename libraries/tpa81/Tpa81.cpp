/*
  ...
  // developer by hamed torky - 2014 july 12
*/
...
int Tpa81::changeI2CAddress(char oldAddress , char newAddress)
{
	Wire.beginTransmission(oldAddress>>1);
